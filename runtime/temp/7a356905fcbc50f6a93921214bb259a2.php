<?php /*a:3:{s:80:"D:\phpStudy\PHPTutorial\WWW\smilexpress\application\home\view\download_list.html";i:1545043811;s:78:"D:\phpStudy\PHPTutorial\WWW\smilexpress\application\home\view\common_head.html";i:1545043811;s:80:"D:\phpStudy\PHPTutorial\WWW\smilexpress\application\home\view\common_footer.html";i:1545043811;}*/ ?>
<!DOCTYPE html>
            ...
            <aside>
                <ul class="popular-list">
                    ...
                    <li style="position: relative;">
                        ...
                        <p class="author-name">
                            <a style="font-style: normal;display: inline-block;padding:3px 12px;border: 1px solid #eee; position: absolute;bottom:30px;right: 15px;" href="<?php echo url('home/index/down',['id'=>$vo['id']]); ?>">下载文件</a>
                        </p>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
        ...
        <div class="four columns">
            <aside>
                ...
                <ul class="sidebar-list">
                    <?php  $catid = input("catId"); $result = db("download")->where("posid = 2 and catid=".$catid." ")->limit(10)->order("")->select();foreach ($result as $k=>$vo):$result[$k]["time"]= isset($vo["createtime"])?toDate($vo["createtime"]):""?>
                    <li><a href="<?php echo url('home/index/down',['id'=>$vo['id']]); ?>" style="<?php echo style($vo['title_style']); ?>" title="<?php echo htmlentities($vo['title']); ?>"><?php echo htmlentities($vo['title']); ?></a></li>
                    <?php endforeach?>
                </ul>
            </aside>
        </div>
...
<script id="cy_cmt_num" src="https://changyan.sohu.com/upload/plugins/plugins.list.count.js?clientId=<?php echo htmlentities($changyan['app_id']); ?>"></script>